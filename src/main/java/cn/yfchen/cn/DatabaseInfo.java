...
public class DatabaseInfo {
     ...
     * @throws SQLException
     */
    public DatabaseInfo(String host,String user,String password,String db, String ssl) throws SQLException {
        this.host=host;
        this.user=user;
        this.password=password;
        this.db=db;
        this.DB_URL= "jdbc:mysql://"+this.host+":3306/information_schema?characterEncoding=utf8&useSSL=" + ssl;
